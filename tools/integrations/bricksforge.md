...
WordPress extension for Bricks Builder with forms, interactions, and dynamic site features.
...
```bash
POST https://example.com/wp-json/bricksforge/v1/records/{record_id}
...
```bash
wp option list --search='bricksforge' --format=table
```
