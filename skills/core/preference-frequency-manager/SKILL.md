...
1. Define the exact `preference frequency manager` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for preference frequency manager. Distinguish direct observations from assumptions and proxies.
4. Execute the preference frequency manager analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
