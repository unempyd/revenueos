...
WordPress page builder form component for lead capture and contact workflows.
...
```bash
POST https://example.com/wp-json/brizy-form/v1/records/{record_id}
...
```bash
wp option list --search='brizy-form' --format=table
```
