---
name: seo-audit
description: "Audit a site or page across technical SEO, on-page quality, content, structured data, performance, indexability, AI-search readiness and conversion-sensitive search experience."
license: Apache-2.0
metadata:
  version: "1.0.0"
  domain: "seo-geo"
...
Use this skill for **seo audit**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `seo audit` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for seo audit. Distinguish direct observations from assumptions and proxies.
4. Execute the seo audit analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
