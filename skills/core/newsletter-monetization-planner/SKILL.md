...
Use this skill for **newsletter monetization planner**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `newsletter monetization planner` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for newsletter monetization planner. Distinguish direct observations from assumptions and proxies.
4. Execute the newsletter monetization planner analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
