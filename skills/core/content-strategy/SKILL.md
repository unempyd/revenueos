...
Use this skill for **content strategy**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `content strategy` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for content strategy. Distinguish direct observations from assumptions and proxies.
4. Execute the content strategy analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
...
- Message/angle
- Evidence and claims
- Structure and information gain
- Voice consistency
- CTA and next step
