...
Use this skill for **competitor analysis**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `competitor analysis` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for competitor analysis. Distinguish direct observations from assumptions and proxies.
4. Execute the competitor analysis analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
