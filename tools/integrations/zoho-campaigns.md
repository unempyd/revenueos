...
Email marketing platform for mailing lists, campaigns, contacts, and automation.
...
- **Get token**: Developer settings, API settings, private app settings, or webhook settings inside the Zoho Campaigns dashboard
