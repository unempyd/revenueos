...
description: "Stress-test a marketing decision using multiple expert lenses and synthesize disagreements into a clear decision with evidence and risks."
license: Apache-2.0
metadata:
  version: "1.0.0"
  domain: "strategy"
...
Use this skill for **marketing council**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `marketing council` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for marketing council. Distinguish direct observations from assumptions and proxies.
4. Execute the marketing council analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
