---
name: prospecting
description: "Build qualified prospect lists using an explicit ICP, source provenance, qualification criteria, scoring, enrichment hygiene and outreach-compliance checks."
license: Apache-2.0
metadata:
  version: "1.0.0"
  domain: "gtm-sales"
...
Use this skill for **prospecting**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `prospecting` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for prospecting. Distinguish direct observations from assumptions and proxies.
4. Execute the prospecting analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
