...
Use this skill for **cold email**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `cold email` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for cold email. Distinguish direct observations from assumptions and proxies.
4. Execute the cold email analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
