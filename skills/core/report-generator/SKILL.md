...
1. Define the exact `report generator` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for report generator. Distinguish direct observations from assumptions and proxies.
4. Execute the report generator analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
