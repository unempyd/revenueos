...
Webinar platform for registration, attendees, panelists, recordings, and webinar analytics.
...
- **Get token**: Developer settings, API settings, private app settings, or webhook settings inside the Zoom Webinar dashboard
