...
Use this skill for **narrative baseline mapper**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `narrative baseline mapper` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for narrative baseline mapper. Distinguish direct observations from assumptions and proxies.
4. Execute the narrative baseline mapper analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
