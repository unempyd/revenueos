...
Use this skill for **press media relations**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `press media relations` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for press media relations. Distinguish direct observations from assumptions and proxies.
4. Execute the press media relations analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
