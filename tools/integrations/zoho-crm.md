...
CRM platform for leads, contacts, accounts, deals, tasks, campaigns, and sales automation.
...
- **Get token**: Developer settings, API settings, private app settings, or webhook settings inside the Zoho CRM dashboard
...
```bash
GET https://www.zohoapis.com/crm/v2/records?limit=50
...
```bash
GET https://www.zohoapis.com/crm/v2/records/{record_id}
...
```bash
POST https://www.zohoapis.com/crm/v2/records
...
```bash
PATCH https://www.zohoapis.com/crm/v2/records/{record_id}
...
```bash
POST https://www.zohoapis.com/crm/v2/events
