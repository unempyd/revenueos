...
Use this skill for **competitor profiling**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `competitor profiling` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for competitor profiling. Distinguish direct observations from assumptions and proxies.
4. Execute the competitor profiling analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
