...
WordPress form builder for contact forms, lead capture, surveys, payments, and registrations.
...
```bash
POST https://example.com/wp-json/wpforms/v1/records/{record_id}
...
```bash
wp option list --search='wpforms' --format=table
```
