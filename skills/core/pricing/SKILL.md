---
name: pricing
description: "Design or evaluate pricing and packaging using customer value, willingness-to-pay evidence, competitive context, unit economics and experiment design."
license: Apache-2.0
metadata:
  version: "1.0.0"
  domain: "gtm-sales"
...
Use this skill for **pricing**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `pricing` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for pricing. Distinguish direct observations from assumptions and proxies.
4. Execute the pricing analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
