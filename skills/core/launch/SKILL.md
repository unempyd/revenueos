---
name: launch
description: "Plan and run product or feature launches from positioning and tiering through asset readiness, launch-day orchestration, feedback and momentum."
license: Apache-2.0
metadata:
  version: "1.0.0"
  domain: "gtm-sales"
...
Use this skill for **launch**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `launch` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for launch. Distinguish direct observations from assumptions and proxies.
4. Execute the launch analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
