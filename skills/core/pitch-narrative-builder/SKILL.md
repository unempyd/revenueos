...
Use this skill for **pitch narrative builder**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `pitch narrative builder` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for pitch narrative builder. Distinguish direct observations from assumptions and proxies.
4. Execute the pitch narrative builder analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
