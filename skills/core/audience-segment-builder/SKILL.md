...
Use this skill for **audience segment builder**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `audience segment builder` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for audience segment builder. Distinguish direct observations from assumptions and proxies.
4. Execute the audience segment builder analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
