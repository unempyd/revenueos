...
WordPress form builder for advanced forms, calculations, payments, and conditional logic.
...
```bash
POST https://example.com/wp-json/ws-form/v1/records/{record_id}
...
```bash
wp option list --search='ws-form' --format=table
```
