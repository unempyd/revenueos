...
description: "Design scalable SEO page systems using templates, structured data sources, quality thresholds, internal linking, indexation controls and anti-thin-content gates."
license: Apache-2.0
metadata:
  version: "1.0.0"
  domain: "seo-geo"
...
Use this skill for **programmatic seo**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `programmatic seo` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for programmatic seo. Distinguish direct observations from assumptions and proxies.
4. Execute the programmatic seo analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
