...
Use this skill for **site architecture**. Start from the user’s concrete objective and available evidence; do not substitute generic marketing advice for task-specific analysis.
...
1. Define the exact `site architecture` objective, audience/scope, constraints and success metric before recommending action.
...
3. Collect the minimum evidence needed for site architecture. Distinguish direct observations from assumptions and proxies.
4. Execute the site architecture analysis or artifact using the domain checklist below; prefer specific outputs over generic best-practice lists.
