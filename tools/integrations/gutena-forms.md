...
WordPress block form plugin for Gutenberg-based lead capture and contact forms.
...
```bash
POST https://example.com/wp-json/gutena-forms/v1/records/{record_id}
...
```bash
wp option list --search='gutena-forms' --format=table
```
